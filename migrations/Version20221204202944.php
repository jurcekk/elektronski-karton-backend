 ...
 */
final class Version20221204202944 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6497C7BDE9E FOREIGN KEY (health_record_id) REFERENCES health_record (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
